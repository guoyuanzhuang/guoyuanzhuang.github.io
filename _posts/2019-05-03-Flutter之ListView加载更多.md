---
layout:     post
title:      Flutter之ListView加载更多
subtitle:   实现ListView分页加载，上拉加载更多数据
date:       2019-05-03
author:     John Guo
...
# 准备工作
列表分页加载是我们开发中经常使用的场景，那我们去一步步实现它；我们需要思考几个点：  

* 滑动到底部逻辑判断
* 加载状态的处理；加载中，加载完成，没有更多数据
...
# 总结
注释写的很详细了，这里虽然实现了分页加载，但是要实际使用的话，需要继续封装把它封装成组件，这样使用方便，这里就不写了。

GitHub源码：[ListView加载更多-源码](https://github.com/guoyuanzhuang/flutterTest/blob/master/lib/PullRefreshListView.dart)